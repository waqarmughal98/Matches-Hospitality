...
const Navbar = () => {
  return (
    <nav className={`bg-primaryBlack border-gray-200 px-16`}>
    <div className=" flex flex-wrap items-center justify-between py-4">
        ...
        <div className="flex lg:order-1">
            ...
            <div className="relative hidden lg:block w-[35rem]">
                ...
                <input type="text" id="search-navbar" className="block w-full p-2 ps-10 text-sm text-gray-900 border border-[#2E3539] rounded-full bg-transparent focus:ring-blue-500 focus:border-blue-500 dark:bg-transparent dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search Matches, Players, Stats ..." />
            </div>
