...
const MatchCard = ({ data, onClick, width, overlay }) => {
    ...
    return (
        <div className={` ${width === 'small' ? 'xl:col-span-4' : 'xl:col-span-3'} group md:col-span-6 col-span-12 bg-[#141414] cursor-pointer rounded-xl px-5 py-6 text-white relative font-roboto ${data.id == selectedMatch ? 'border-1 border-primaryGreen' : ''}`} onClick={onClick} >
            {overlay && (
