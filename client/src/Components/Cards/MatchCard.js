...
const MatchCard = ({ data, onClick, fontSize, width }) => {
    ...
    return (
        <div className={` ${width === 'small' ? 'xl:col-span-4' : 'xl:col-span-3'} md:col-span-6 col-span-12 bg-[#141414] rounded-xl px-4 py-6 text-white ${data.id == selectedMatch ? 'border-2 border-primaryGreen' : 'border-2 border-transparent'}`} onClick={onClick} >
