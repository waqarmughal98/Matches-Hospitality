    ...
    return (
        <div className='flex-1'>
            <div class="relative p-10 text-center rounded-lg bg-black/30 backdrop-blur-xl sm:p-5 shadow-lg">
                <button type="button" onClick={closeModal} class="text-gray-400 absolute top-2.5 right-2.5 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="deleteModal">
